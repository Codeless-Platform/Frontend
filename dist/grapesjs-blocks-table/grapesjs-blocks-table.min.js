                ...
                model: {
                  ...
                  setData() {
                    ...
                    async function fetchData() {
                      ...
                      const userData = selectedAPI.json;
                      ...
                      components.add(createTable(dataArray));
                    ...
                    function createTable(userData) {
                      ...
                      dataArray.forEach((user) => {
                        const columnsToAdd = headers.map((header) => ({
                          type: 'customCell',
                          components: `${createTableCell(user[header])}`,
                        }));
                    ...
                    function createTableCell(value) {
                      if (typeof value === 'object' && !Array.isArray(value)) {
                        ...
                        Object.entries(value).forEach(([key, innerValue]) => {
                          innerTable += `<tr><td>${key}</td><td>${createTableCell(
                            innerValue
                          )}</td></tr>`;
                        });
                        innerTable += '</table>';
                        ...
                        let innerTable = '<table>';
                        value.forEach((item) => {
                          innerTable += `<tr><td>${createTableCell(
                            item
                          )}</td></tr>`;
                        });
                        innerTable += '</table>';
