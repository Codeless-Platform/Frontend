                ...
                (function (e) {
                  let n =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ...
                      : {};
                  const o = e.Commands;
                  o.add('table-show-columns-operations', () => {
                    c(
                      e,
                      'columns',
                      'rows',
                    ...
                    o.add('table-show-rows-operations', () => {
                      c(
                        e,
                        'rows',
                        'columns',
                    ...
                    o.add('table-select', (e) => {
                      e.runCommand('core:component-exit'),
                        e.runCommand('core:component-exit');
                    }),
                    o.add('table-insert-row-above', (e) => {
                      let t = e.getSelected();
                    ...
                    o.add('table-insert-row-below', (e) => {
                      let t = e.getSelected();
                      if (
                    ...
                    o.add('table-insert-column-left', (e) => {
                      let t = e.getSelected();
                    ...
                    o.add('table-insert-column-right', (e) => {
                      let t = e.getSelected();
                      (t.is(n.componentCell) || t.is(n.componentCellHeader)) &&
                        (r(
                          t.parent().parent(),
                    ...
                    o.add('table-merge-cells-right', (e) => {
                      let o = e.getSelected();
                      if (
                    ...
                    o.add('table-merge-cells-down', (e) => {
                      let o = e.getSelected();
                    ...
                    o.add('open-table-settings-modal', {
                      run(e, t) {
                        let n =
                        ...
                        e.Modal.open({
                          ...
                          content:
                            ...
                            n.model.props()['nRows'] +
                            '" name="nRows" id="nRows" min="1">\n                    </span>\n                    <span class="gjs-field-units"></span>\n                    <div class="gjs-field-arrows" data-arrows="">\n                      <div class="gjs-field-arrow-u" data-arrow-up=""></div>\n                      <div class="gjs-field-arrow-d" data-arrow-down=""></div>\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n            <div>\n              <input id="table-button-create-new" type="button" value="Create Table" class="gjs-btn-prim" data-component-id="' +
                            n.model.cid +
                            '">\n            </div>\n          </div>\n',
                        }).onceClose(() => {
                          (n.model.components() &&
                    ...
                    o.add('table-row-move-up', () => {
                      let t = e.getSelected();
                      t.is(n.componentCell) && (f(t.parent(), -1), p(e));
                    }),
                    o.add('table-row-move-down', () => {
                      let t = e.getSelected();
                      t.is(n.componentCell) && (f(t.parent(), 1), p(e));
                    });
                })(e, n);
