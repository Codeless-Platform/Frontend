...
declare class StyleableModel<T extends ObjectHash = any> extends Model<T> {
   ...
   */
  setStyle(
    prop?: string | ObjectAny,
    opts?: UpdateStyleOptions
  ): {
    [x: string]: any;
  };
  /**
...
export type ModuleModelExt<TItem extends ModuleModel | ModuleCollection> = TItem extends ModuleCollection<infer M>
  ? ModuleFromModel<M>
  : TItem extends ModuleModel<infer M>
  ? M
  : unknown;
declare class ModuleView<
...
declare abstract class ModuleDomainViews<
...
declare class CssComposer extends ItemManagerModule<
  CssComposerConfig & {
    pStylePrefix?: string;
  }
> {
...
Component> {
  ...
  initClasses(): void;
  initComponents(opts?: { avoidRender?: boolean }): void;
  /**
   ...
   * @private
   * */
  updateStatus(opts?: { noExtHl?: boolean; avoidHover?: boolean }): void;
  /**
...
declare class CanvasModule extends Module<CanvasConfig> {
   ...
   * });
   */
  addSpot<T extends CanvasSpotProps>(
    props: Omit<T, 'id'> & {
      id?: string;
    },
    opts?: AddOptions
...
export declare class Frame extends ModuleModel<CanvasModule> {
  ...
  addHeadItem(item: { tag: string; attributes: any }): void;
  getHeadByAttr(
    attr: string,
    value: any,
    tag: string
...
declare class TraitView extends View<Trait> {
  ...
  onEvent(
    props: ReturnType<TraitView['getClbOpts']> & {
      event: Event;
    }
  ): void;
  /**
...
export declare class Trait extends Model<TraitProperties> {
   ...
   * @returns {String}
   */
  getLabel(opts?: { locale?: boolean }): any;
  /**
   * Get the trait value.
...
declare class Resizer {
  ...
  updateContainer(opt?: { forceShow?: boolean }): void;
  /**
...
declare class ComponentImage extends Component {
  ...
  getSrcResult(opt?: { fallback?: boolean }): any;
...
declare class RichTextEditorModule extends Module<
...
export declare class Component extends StyleableModel<ComponentProperties> {
  ...
  __postAdd(opts?: { recursive?: boolean }): void;
  __postRemove(): void;
   ...
   * @private
   */
  clone(opt?: { symbol?: boolean; symbolInv?: boolean }): any;
  /**
   ...
   * @returns {String}
   * */
  getName(opts?: { noCustom?: boolean }): any;
  /**
   * Get the icon string
   * @return {String}
   */
   ...
   */
  resetId(opts?: {}): this;
  _getStyleRule({ id }?: { id?: string }): CssRule | undefined;
  _getStyleSelector(opts?: { id?: string }): Selector | undefined;
  _idUpdated(
    m: any,
    v: any,
    opts?: {
...
declare class CategoryView extends View<Category> {
  ...
  template({ pfx, label }: { pfx: string; label: string }): string;
  /** @ts-ignore */
  attributes(): Record<string, any>;
...
export declare class Sector extends Model<SectorProperties> {
   ...
   */
  getProperties(opts?: { withValue?: boolean; withParentValue?: boolean }): Property<PropertyProps>[];
...
export declare class PropertyComposite<T extends Record<string, any> = PropertyCompositeProps> extends Property<T> {
   ...
   */
  getValues({ byName }?: { byName?: boolean }): Record<string, any>;
  /**
  ...
  getStyle(opts?: { camelCase?: boolean }): StyleProps;
...
export declare class Property<T extends Record<string, any> = PropertyProps> extends Model<T> {
   ...
   * @returns {String}
   */
  getValue(opts?: { noDefault?: boolean }): string | T['value'] | undefined;
  /**
...
export interface EditorConfig {
   ...
   * @default 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.0.0/css/font-awesome.min.css'
   * */
  cssIcons?: string;
  /**
...
declare class BlockManager extends ItemManagerModule<BlockManagerConfig, Blocks> {
  ...
  __endDrag(opts?: { component?: Component }): void;
...
declare class SectorsView extends View {
  ...
  addToCollection(
    model: Sector,
    fragmentEl: DocumentFragment | null,
    opts?: {
      at?: number;
    }
  ): HTMLElement;
...
export interface ICustomPropertyView {
  ...
  update?: (
    data: ReturnType<PropertyView['_getClbOpts']> & {
      value: string;
    }
  ) => any;
...
declare class Layer extends Model<LayerProps> {
   ...
   * @returns {Object}
   */
  getValues(opts?: { camelCase?: boolean }): LayerValues;
  /**
   * Get layer label.
   * @returns {String}
   */
...
declare class StyleManager extends ItemManagerModule<
  StyleManagerConfig,
  /** @ts-ignore */
  Sectors
> {
  ...
  constructor(em: EditorModel);
  __upSel(): void;
  __trgCustom(opts?: { container?: HTMLElement }): void;
  ...
  addBuiltIn(
    prop: string,
    definition: Omit<PropertyProps, 'property'> & {
      proeperty?: 'string';
    }
  ): any;
  /**
...
export type SelectorStringObject =
  | string
  | {
      name?: string;
      label?: string;
...
declare class SelectorManager extends ItemManagerModule<
...
declare class ParserModule extends Module<
  ParserConfig & {
    name?: string;
  }
> {
...
export type StorageEvent =
  ...
  | 'storage:error:store'
  | 'storage:error:load';
declare class StorageManager extends Module<
...
declare class TraitManager extends Module<
  TraitManagerConfig & {
    pStylePrefix?: string;
  }
> {
...
declare class DevicesView extends View {
  ...
  template({ ppfx, label }: { ppfx: string; label: string }): string;
  events(): {
    change: string;
...
declare class DeviceManager extends ItemManagerModule<
  DeviceManagerConfig & {
    appendTo?: HTMLElement | string;
  },
  Devices
...
declare class I18nModule extends Module<
  I18nConfig & {
    stylePrefix?: string;
  }
> {
...
declare class KeymapsModule extends Module<
  KeymapsConfig & {
    name?: string;
  }
> {
...
declare class CodeEditorView extends View {
  pfx?: string;
  config: Record<string, any>;
  template({ pfx, codeName, label }: { pfx: string; codeName: string; label: string }): string;
  initialize(o: any): void;
  render(): this;
}
declare class CodeManagerModule extends Module<
  CodeManagerConfig & {
    pStylePrefix?: string;
  }
> {
...
declare class UndoManagerModule extends Module<
  UndoManagerConfig & {
    name?: string;
    _disable?: boolean;
  }
...
declare class CommandsModule extends Module<
  CommandsConfig & {
    pStylePrefix?: string;
  }
> {
...
declare abstract class ItemManagerModule<
...
export type EditorBuiltInEvents =
  | ComponentEvent
  | BlockEvent
  | AssetEvent
  | KeymapEvent
...
export declare class Editor implements IBaseModule<EditorConfig> {
   ...
   */
  select(
    el?: EditorModelParam<'setSelected', 0>,
    opts?: {
      scroll?: boolean;
    }
  ): this;
...
export declare const usePlugin: <P extends string | Plugin<any>>(
  plugin: P,
  opts?:
    | (P extends Plugin<
        infer C extends {
...
export declare const grapesjs: {
  ...
  usePlugin: <P extends string | Plugin<any>>(
    plugin: P,
    opts?:
      | (P extends Plugin<
          infer C extends {
